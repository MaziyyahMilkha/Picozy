...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class NiceVibrationsDefineSymbols
	{
		...
		static NiceVibrationsDefineSymbols()
		{
			...
			string scriptingDefinesString = PlayerSettings.GetScriptingDefineSymbolsForGroup(buildTargetGroup);
			...
			PlayerSettings.SetScriptingDefineSymbolsForGroup(buildTargetGroup, string.Join(";", scriptingDefinesStringList.ToArray()));
		}
	}
	#endif
}